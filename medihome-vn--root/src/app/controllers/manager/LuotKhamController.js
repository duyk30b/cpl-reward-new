const Collection = require('../../models/LuotKham');

class CollectionController {
	//--[RENDER]--       /list                               -- Get List --
	renderList(req, res, next) {
		res.render('manager/luot-kham/luotkham-list');
	}
	renderAdd(req, res, next) {
		res.render('manager/luot-kham/luotkham-add');
	}
	//--[RENDER]--       /list                               -- Get List --
	renderTrash(req, res, next) {
		res.render('manager/luot-kham/luotkham-trash');
	}
	//--[GET]--       /list                               -- Get List --
	list(req, res, next) {
		let conditions = {
