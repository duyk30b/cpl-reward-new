...
export class createUserRewardHistoriesTable1648454632120 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.dropForeignKeys('user_reward_histories', table.foreignKeys)
