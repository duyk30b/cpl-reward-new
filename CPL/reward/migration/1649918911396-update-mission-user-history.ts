...
export class updateMissionUserHistory1649918911396 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.dropColumns('mission_user_logs', ['referred_user_info', 'total_money_earned'])
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.dropColumns('mission_user_logs', ['currency', 'user_type'])
