        ...
        <div class="row mb-4">
          ...
          <div class="col-3 mr-8">
            <el-input
              ...
              :placeholder="$t('walletGeneral.userId')"
              clearable
            />
          </div>
...
export default defineComponent({
  setup() {
    ...
    const getData = () => {
      ...
      if (searchUserId.value) {
        p.search_user_id = searchUserId.value
      }
    ...
    onMounted(() => {
      setPageFliud()
      setCurrentPageBreadcrumbs('menu.walletSub.walletService.userWalletList', [
        'menu.wallet',
        'menu.walletSub.walletService.index',
      ])
  ...
  watch: {
    ...
    searchUserId() {
      this.searchUserId = this.searchUserId.toString().replace(/[^\d]/g, '')
    },
  },
})
</script>
