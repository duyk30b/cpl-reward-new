    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      <div class="modal-content">
        <div class="modal-header">
          <h2 class="fw-bolder">
            {{ isEdit ? $t('unlimitedUser.update') : $t('unlimitedUser.add') }}
          </h2>
          <div
    ...
    onClick() {
      ...
      if (this.isEdit) {
        ...
        ElMessageBox.confirm('Are you sure to update?').then(() => {
          ...
          this.loading = true
          ExchangeHistoryService.updateUnlimitedUser(param)
            .then((res) => {
      ...
      ElMessageBox.confirm('Are you sure to add?').then(() => {
        ...
        ExchangeHistoryService.addUnlimitedUser(param).then((res) => {
          if (res && res.status === 200) {
            this.$emit('updateData')
            this.$toastr.success(this.$t('success'))
            hideModal(this.$refs.blackListModalRef)
