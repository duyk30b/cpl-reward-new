                ...
                <template v-for="(cell, i) in tableHeader" :key="i">
                  <th
                    ...
                    :class="[
                      ...
                      cell.key.includes('MOTHER_WALLET_ADDRESS') &&
                        'min-w-350px',
                    ...
                    <template v-for="(cell, i) in tableHeader" :key="i">
                      ...
                      >
                        <slot :name="`cell-${cell.key}`" :row="item">
                          ...
                          >
                            <template
                              v-for="(address, index) in item[cell.key].split(
                                `,`,
                              )"
                              :key="index"
                            >
...
export default defineComponent({
  ...
  setup() {
    ...
    const coinEdit = ref()
    const openEdit = (coin) => {
      titleModal.value = t('menu.walletSettingSub.motherWalletSetting')
    ...
    const { t } = useI18n()
    const openAdd = () => {
      titleModal.value = t('motherWalletSetting')
      coinEdit.value = ''
    ...
    onMounted(() => {
      setPageFliud()
      setCurrentPageBreadcrumbs('menu.walletSettingSub.motherWalletSetting', [
        'menu.walletSettingSub.motherWalletSetting',
      ])
