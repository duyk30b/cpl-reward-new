...
export default defineComponent({
  ...
  setup() {
    ...
    const getData = () => {
      ...
      loading.value = true
      WalletBceService.getBceWithdrawHistory(params).then((res) => {
        if (res.data) {
          ...
          items.value = responseData.map((item) => {
            ...
            item.fee = fee + ' ' + item.currency_fee.toUpperCase()
    ...
    onMounted(() => {
      setPageFliud()
      setCurrentPageBreadcrumbs('menu.walletSub.history.withdrawHistory', [
    ...
    const exportWithdrawHistory = () => {
      const params = getFilterParams()
      loadingExport.value = true
      WalletBceService.exportWithdrawHistory(params)
        .then((res) => {
          if (res.data) {
