...
import { IGrpcUnlimitedUser } from './unlimited-user.interface'

export class GrpcUnlimitedUserDTO {
  @Expose()
  id: number
...
export class GrpcUnlimitedUserResponseDTO extends BaseResponseDto {
  data?: IGrpcUnlimitedUser
}

export class ListGrpcUnlimitedUserResponseDTO extends BaseResponseDto {
  data?: {
    items: IGrpcUnlimitedUser[]
    meta: IPaginationMeta
  }
}

export class GrpcUserUnLimitedDTO {
  @Expose()
  id: number
...
export class GrpcUserUnlimitedResponseDTO extends BaseResponseDto {
  data?: {
    items: GrpcUserUnLimitedDTO[]
    meta: IPaginationMeta
  }
}
