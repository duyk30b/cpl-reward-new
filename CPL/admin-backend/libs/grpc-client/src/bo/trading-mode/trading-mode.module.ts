...
import { GrpcTradingModeService } from './trading-mode.service'

@Module({
  imports: [ConfigModule.forFeature(grpcClientConfig)],
  providers: [
    {
      provide: 'BO_TRADING_MODE_PACKAGE',
    ...
    GrpcTradingModeService,
  ],
  exports: [GrpcTradingModeService],
})
export class GrpcTradingModeModule {}
